        ...
        <div className="py-8 md:py-12">
          ...
          <div className="text-center md:flex md:items-center md:justify-between mb-8 md:mb-6">
            ...
            <ul className="inline-flex mb-4 md:order-2 md:ml-4 md:mb-0">
              <li>
                <a
                  className="flex justify-center items-center text-[#030442] bg-gray-100 hover:text-white hover:bg-[#030442] rounded-full transition duration-150 ease-in-out"
                  href="#0"
                  aria-label="Twitter"
                >
                  <svg
          ...
          <div className="text-xs text-gray-400 text-center md:text-left">
            A non-governmental organization dedicated to creating empowerment
            programs for youth, women, and children, focusing on health safety,
