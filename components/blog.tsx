          ...
          <div className="max-w-sm mx-auto md:max-w-none grid gap-12 md:grid-cols-3 md:gap-x-6 md:gap-y-8 items-start">
            ...
            <article className="h-full flex flex-col space-y-5" data-aos="fade-down">
              ...
              <a className="block group overflow-hidden" href="#0">
                <Image className="w-full aspect-[7/4] object-cover group-hover:scale-105 transition duration-700 ease-out" src={Post01} width={347} height={198} alt="Post 01" />
              </a>
              {/* Content */}
              <div className="grow flex flex-col">
                ...
                <footer className="flex items-center text-sm mt-4">
                  <a href="#0">
                    <Image className="rounded-full shrink-0 mr-3" src={PostAuthor01} width={32} height={32} alt="Author 01" />
                  </a>
                  <div>
            ...
            <article className="h-full flex flex-col space-y-5" data-aos="fade-down" data-aos-delay="100">
              {/* Image */}
              <a className="block group overflow-hidden" href="#0">
                <Image className="w-full aspect-[7/4] object-cover group-hover:scale-105 transition duration-700 ease-out" src={Post02} width={347} height={198} alt="Post 02" />
              </a>
              {/* Content */}
              <div className="grow flex flex-col">
                <header>
                ...
                <footer className="flex items-center text-sm mt-4">
                  <a href="#0">
                    <Image className="rounded-full shrink-0 mr-3" src={PostAuthor02} width={32} height={32} alt="Author 02" />
                  </a>
                  <div>
            ...
            <article className="h-full flex flex-col space-y-5" data-aos="fade-down" data-aos-delay="200">
              {/* Image */}
              <a className="block group overflow-hidden" href="#0">
                <Image className="w-full aspect-[7/4] object-cover group-hover:scale-105 transition duration-700 ease-out" src={Post03} width={347} height={198} alt="Post 03" />
              </a>
              {/* Content */}
              <div className="grow flex flex-col">
                <header>
                ...
                <footer className="flex items-center text-sm mt-4">
                  <a href="#0">
                    <Image className="rounded-full shrink-0 mr-3" src={PostAuthor03} width={32} height={32} alt="Author 03" />
                  </a>
                  <div>
