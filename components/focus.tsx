    ...
    <div className="relative  bg-gray-100 shadow-black/[0.03] mt-24">
      <div className="flex flex-wrap justify-center">
        <div className="items-center mx-6 rounded-md shadow-md p-8 w-full md:w-1/2 lg:w-auto mb-4">
          ...
          <h1 className="text-purple-400 text-center font-bold text-lg">3250 +</h1>
          <h1 className="text-purple-400 text-center">Members</h1>
        </div>
        <div className="items-center mx-6 rounded-md shadow-md p-8 w-full md:w-1/2 lg:w-auto mb-4">
          <div className="mb-1 flex justify-center">
            <svg
          ...
          <h1 className="text-purple-400 text-center font-bold text-lg">23250 +</h1>
          <h1 className="text-purple-400 text-center">Pictures</h1>
        </div>
        <div className="items-center mx-6 rounded-md shadow-md p-8 w-full md:w-1/2 lg:w-auto mb-4">
          <div className="mb-1 flex justify-center">
            <svg
          ...
          <h1 className="text-purple-400 text-center font-bold text-lg">325 +</h1>
          <h1 className="text-purple-400 text-center">Events</h1>
        </div>
        <div className="items-center mx-6 rounded-md shadow-md p-8 w-full md:w-1/2 lg:w-auto mb-4">
          <div className="mb-1 flex justify-center">
            <svg
          ...
          <h1 className="text-purple-400 text-center font-bold text-lg">6000 +</h1>
          <h1 className="text-purple-400 text-center">Awards</h1>
